...
const comparisonData: { feature: string; wodomat: string; others: string; highlight: boolean; isPrice?: boolean }[] = [
  ...
  { feature: 'ЖКИ-дисплей 19"', wodomat: "Есть", others: "Нет", highlight: true },
  ...
  { feature: "Цена водомата", wodomat: "10 450 руб.", others: "ОТ 14 000 руб.", highlight: true, isPrice: true },
];
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          <h2 className="font-heading font-bold text-3xl md:text-4xl text-foreground mb-3">
            <span className="text-gradient-water">WODOMAT S</span> vs другие производители
          </h2>
                ...
                <tr className="border-b border-border/50">
                  ...
                  <th className="p-4 md:p-5 text-center w-[35%]">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-primary/10 border border-primary/20">
                      <span className="font-heading font-bold text-primary text-base">WODOMAT S</span>
                    </div>
                  </th>
