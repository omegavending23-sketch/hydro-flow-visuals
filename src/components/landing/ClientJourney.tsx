...
const ClientJourney = () => (
  <section className="section-padding bg-background">
    <div className="container mx-auto">
      ...
      >
        Как мы <span className="text-primary">сопровождаем</span> клиента
      </motion.h2>
      ...
      <div className="hidden md:flex items-start justify-between relative mb-14">
        ...
        {steps.map((s, i) => (
          ...
          >
            <div className="w-16 h-16 rounded-full bg-primary/10 border-4 border-background flex items-center justify-center z-10 mb-4">
